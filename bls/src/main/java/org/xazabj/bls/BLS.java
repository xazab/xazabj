...
public class BLS {
  ...
  public static final String XAZABJ_VERSION = "0.17.4";
  ...
  static {
    ...
    try
    {
      ...
      Preconditions.checkState(GetVersionString().equals(XAZABJ_VERSION),
              "xazabjbls:  C++ Source Version doesn't match Java Source version:" +
              "C++: " + GetVersionString() + " Java: " + XAZABJ_VERSION);
