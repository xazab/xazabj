...
public class VersionMessage extends Message {
     ...
     * Xazab Core sets it to something like "/Satoshi:0.9.1/".
     */
    ...
    public VersionMessage(NetworkParameters params, int newBestHeight) {
        ...
        // Note that the Xazab Core doesn't do anything with these, and finding out your own external IP address
