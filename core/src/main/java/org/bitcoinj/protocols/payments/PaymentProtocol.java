...
public class PaymentProtocol {
    ...
    public static final String MIMETYPE_PAYMENTREQUEST = "application/xazab-paymentrequest";
    public static final String MIMETYPE_PAYMENT = "application/xazab-payment";
    public static final String MIMETYPE_PAYMENTACK = "application/xazab-paymentack";
