...
public class DefaultRiskAnalysis implements RiskAnalysis {
     ...
     * different when the fee is about to change in Xazab Core.
     */
    ...
    /**
     * <p>Checks if a transaction is considered "standard" by Xazab Core's IsStandardTx and AreInputsStandard
     * functions.</p>
     *
