...
public class SendRequest {
     ...
     * when choosing which transactions to add to a block. Note that, to keep this equivalent to Xazab Core
     * definition, a kilobyte is defined as 1000 bytes, not 1024.</p>
     */
    public Coin feePerKb = Context.get().getFeePerKb();

    /**
     * <p>Requires that there be enough fee for a default Xazab Core to at least relay the transaction.
