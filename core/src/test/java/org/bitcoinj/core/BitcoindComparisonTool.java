...
/**
 * A tool for comparing the blocks which are accepted/rejected by xazabd/xazabj
 * It is designed to run as a testnet-in-a-box network between a single xazabd node and xazabj
...
public class BitcoindComparisonTool {
    ...
    public static void main(String[] args) throws Exception {
        ...
        System.out.println("USAGE: xazabjBlockStoreLocation runExpensiveTests(1/0) [port=18444]");
